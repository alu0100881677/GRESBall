/**
 * Se encarga de controlar el menú de los niveles y la store, de tal forma que gestiona y reescala cada objeto en el centro de la pantalla.
 */
...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
	...
	private void NextScreen() {
		FindObjectOfType<AudioManager> ().Play ("NextItem");
